...
This is a Docker image based on [rubensa/ubuntu-tini-dev](https://github.com/rubensa/docker-ubuntu-tini-dev) 18.04 and includes various kubernetes tools.
...
docker run --rm -it \
  ...
  ${ENV_VARS} \
  ${RUNNER} \
  rubensa/ubuntu-tini-dev-k8s:18.04 "$@"
```
